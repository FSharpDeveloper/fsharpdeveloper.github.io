...
on of the most interesting concepts of functional paradigm, is the using of Discriminated Union which help to express our need in a more flexible and language definition oriented, lets take a quick look at some example from MSDN. 
